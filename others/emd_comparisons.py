"""
Not a very useful script - it produces a heatmap of EMD (earth movers distance) distances between the policies of two models,
across their training iterations (res[i,j] - EMD(policy1 at step i, policy2 at step j))
"""
